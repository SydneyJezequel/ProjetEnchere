...
public class VenteManager {
	 ...
	 * @throws SQLException : Les erreurs de type SQLExeception levées dans la classe VenteManagerDAOJdbcImpl sont propagées.
	 * @throws DALException : Les erreurs de type DALException levées dans la classe VenteManagerDAOJdbcImpl sont propagées.
